...
export const PID_ADMIN_GENERATE_RESERVATION = `mutation GenerateReservations($garage_ids: [Id]!, $count: Int!, $date_from: Datetime!, $date_to: Datetime!, $days: [Int]!, $day_from: Int!, $day_to: Int!, $duration_from: Int!, $duration_to: Int!, $client_users: [ClientUserInput], $client_ids: [Id], $internal: Boolean, $user_count: Id) {
