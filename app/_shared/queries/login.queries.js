...
export const LOGIN_USER = `query LoginUser($email: String, $password: String, $refresh_token: String, $device_fingerprint: String, $mobile_app_version: String) { login(email: $email, password: $password, refresh_token: $refresh_token, device_fingerprint: $device_fingerprint, mobile_app_version: $mobile_app_version) }`
