...
const enhancers = compose(
  withMasterPageConf(toAdmin('activityLog')),
  connect(
    state => ({ state: state.adminActivityLog, pageBase: state.pageBase }),
    dispatch => ({ actions: bindActionCreators(adminActivityLogsActions, dispatch) })
  )
)

export default enhancers(ActivityLogPage)
