    ...
    return (
      <div className={styles.flex}>
        <div className={styles.half}>
          <Form
            onSubmit={actions.submitPricings}
...
const enhancers = compose(
  withMasterPageConf(toAdminModules('goPublic')),
  connect(
    state => ({ state: state.adminGoPublic, pageBase: state.pageBase }),
    dispatch => ({ actions: bindActionCreators(goPublicActions, dispatch) })
  )
)

export default enhancers(GoPublicPage)
