import {
  ADMIN_GO_INTERNAL_SET_GARAGE,
  ADMIN_GO_INTERNAL_SET_PLACES,
  ADMIN_GO_INTERNAL_SET_CURRENCIES,
  ADMIN_GO_INTERNAL_SET_CURRENCY_ID,
  ADMIN_GO_INTERNAL_SET_FLAT_PRICE,
  ADMIN_GO_INTERNAL_SET_EXPONENTIAL_12H_PRICE,
...
export default function adminGoInternal(state = defaultState, action) {
  switch (action.type) {
    case ADMIN_GO_INTERNAL_SET_GARAGE:
      return { ...state,
        garage: action.value
      }

    case ADMIN_GO_INTERNAL_SET_PLACES: {
    ...
    case ADMIN_GO_INTERNAL_SET_CURRENCIES:
      return { ...state,
        currencies: action.value
      }

    case ADMIN_GO_INTERNAL_SET_CURRENCY_ID:
      return { ...state,
        currency_id: action.value
      }

    case ADMIN_GO_INTERNAL_SET_FLAT_PRICE:
      return { ...state,
    ...
    case ADMIN_GO_INTERNAL_SET_EXPONENTIAL_12H_PRICE:
      return { ...state,
        exponential_12h_price: { value: action.value, valid: action.valid },
        flat_price:            { value: '', valid: false }
      }

    case ADMIN_GO_INTERNAL_SET_EXPONENTIAL_DAY_PRICE:
      return { ...state,
        exponential_day_price: { value: action.value, valid: action.valid },
        flat_price:            { value: '', valid: false }
      }

    case ADMIN_GO_INTERNAL_SET_EXPONENTIAL_WEEK_PRICE:
      return { ...state,
        exponential_week_price: { value: action.value, valid: action.valid },
        flat_price:             { value: '', valid: false }
      }

    case ADMIN_GO_INTERNAL_SET_EXPONENTIAL_MONTH_PRICE:
      return { ...state,
